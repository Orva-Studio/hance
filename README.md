...
> ⚠️ **Beta software.** Stable on macOS; Linux is lightly tested, so pin versions to be safe. Windows is not supported; binaries ship for macOS (arm64/x64) and Linux (x64/arm64) only.
