...
**Goal:** Rewrite the hancer web UI as a Tailwind-styled, FCP-inspired three-column layout with resizable panels, rename "Preset" to "Look" throughout, add look thumbnail previews and video timeline.
...
```bash
cd /Users/robray/hancer/presets
...
```bash
mkdir -p /Users/robray/hancer/packages/ui/assets
ffmpeg -f lavfi -i "color=c=#4a6741:size=512x512:duration=1" -frames:v 1 -q:v 2 /Users/robray/hancer/packages/ui/assets/reference.jpg -y
```
